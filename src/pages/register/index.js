          ...
          >
            {({
              ...
              <form onSubmit={handleSubmit}>
                <div
                  style={{
                    display: activeScreen === "welcome" ? "block" : "none",
                    height: "100%",
                  }}
                >
                  <video
                ...
                <div
                  style={{
                    display: activeScreen === "earn now" ? "block" : "none",
                    height: "100%",
                  }}
                >
                  <div
                  ...
                  >
                    <div
                      className={`${styles.controls_box} ${styles.earn_control_box}`}
                    >
                      <Image
                ...
                <div
                  style={{
                    display: activeScreen === "submit reel" ? "block" : "none",
                    height: "100%",
                  }}
                >
                  <div
                ...
                <div
                  style={{
                    display: activeScreen === "congrats" ? "block" : "none",
                    height: "100%",
                  }}
                >
                  <div
                    ...
                    <div className={styles.congrats_box}>
                      ...
                      <div className={styles.congrats_container}>
                        ...
                        <p className={styles.congrats_para}>
                          ...
                          pay for themselves. We&rsquo;ll be in touch with you
                          in <span>72 hours.</span>
                        </p>
                      </div>
                    </div>
                  </div>
